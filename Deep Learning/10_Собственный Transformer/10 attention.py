...
# головы - разбивают слова на части и работают (находят взаимосвязь) уже не от целых слов
# а от их чати, тем самым может найти другие зависимости между словами
